  ...
  <script>
   ...
   <script>
        const categoryData = {
            ...
            'agriculture': ['Agricultural Supplies (22)', 'Farms (30)', 'Misc. Agriculture (56)', 'Ranches (5)', 'Vineyards & Wineries (21)'],
            ...
            'franchise-resales': ['Food Franchise Resales (204)', 'Leisure Franchise Resales (60)', 'Misc. Franchise Resales (178)', 'Retail Franchise Resales (54)', 'Service Franchise Resales (345)'],
        ...
        function closeAllMenus() {
            ...
            [countryTrigger, regionTrigger, stateTrigger, cityTrigger, categoryTrigger].forEach(t => t.classList.remove('flr-active-box'));
        }
        ...
        function updateSubCategories(sectorKey, breadcrumbText) {
            ...
            subs.forEach(subName => {
                ...
                itemDiv.innerHTML = `<span>${subName}</span> <i class="fa-solid fa-angle-right" style="font-size:11px; color:#94a3b8;"></i>`;
        ...
        document.querySelectorAll('#flrMainSectorsColumn .flr-category-item').forEach(item => {
            item.addEventListener('click', function(e) {
                e.stopPropagation();
                document.querySelectorAll('#flrMainSectorsColumn .flr-category-item').forEach(el => el.classList.remove('flr-active-parent'));
		...
		document.querySelectorAll('.flr-age-chip-card').forEach(card => {
			card.addEventListener('click', function() {
				document.querySelectorAll('.flr-age-chip-card').forEach(c => c.classList.remove('flr-active-chip'));
