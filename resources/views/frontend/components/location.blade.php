			...
			<section class="bg-light1">
				<div class="container">
                    ...
                    <div class="cards-container">
                        ...
                        <div class="business-card">
                            <div class="card-content">
                                <a href="#" class="card-heading">It is a long established fact that a reader </a>
                                <p class="card-location">San Sanford, Florida</p>
                            </div>
                            
                        </div>
                        <div class="categories-links-wrapper">
                         <a href="#" class="category-link">View all Mid Market businesses <span class="arrow">&rarr;</span></a>
                       </div>
