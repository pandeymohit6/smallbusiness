...
// Init Dropzone only when needed
...
document.addEventListener("DOMContentLoaded", async () => {
    if (document.querySelector("#chartOne")) {
        const module = await import("./components/charts/chart-01");
        module.default();
    }

    if (document.querySelector("#chartTwo")) {
        const module = await import("./components/charts/chart-02");
        module.default();
    }

    if (document.querySelector("#chartThree")) {
        const module = await import("./components/charts/chart-03");
        module.default();
    }

    if (document.querySelector("#userGrowthChart")) {
        const module = await import("./components/charts/user-growth-chart.js");
        module.default();
    }

    if (document.querySelector("#map01")) {
        const module = await import("./components/map-01");
        module.default();
    }

    if (document.querySelector("#calendar")) {
        await import("./components/calendar-init.js");
    }
