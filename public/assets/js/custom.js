(function ($) {
	...
	$(window).scroll(function () {
		...
		if (scroll >=900) {
			$(".fixedfooter-desktop").addClass("show");
		} else {
			$(".fixedfooter-desktop").removeClass("show");
		}
	});
	...
	$(".propertyrange").select2({
		placeholder: "Choose Price..",
		allowClear:false
	});
	
	$(".ptypes").select2({
		placeholder: "Types of Property",
		allowClear:false
	});
